              ...
              >
                <div className="w-72 overflow-hidden gap-2 hover:scale-105 transition-all duration-300 cursor-pointer">
                  ...
                  <div className="flex justify-between mt-4 items-center">
                    ...
                    <p
                      className={`px-4 py-2 rounded-lg text-white w-fit h-[40px] mx-auto
                    ${ele.type === "simple"
                          ? "bg-secondary"
                          : ele.type === "rugged"
                            ? "bg-green-900"
                ...
                <div className="p-8 text-xl capitalize">
                  <ul className="flex gap-16 justify-center">
                    <li
                      ...
                      className={`${typeFilter === "simple" ? "bg-secondary text-white" : "bg-fourth"
                    ...
                    <li
                      ...
                      className={`${typeFilter === "rugged" ? "bg-green-900 text-white" : "bg-fourth"
                        } font-semibold rounded-lg px-4 py-2 cursor-pointer transition-all duration-300`}
                    >
                      rugged
                    </li>
                    <li
                      ...
                      className={`${typeFilter === "luxury" ? "bg-black text-white" : "bg-fourth"
                        } font-semibold rounded-lg px-4 py-2 cursor-pointer transition-all duration-300`}
                    >
                      luxury
                    </li>
